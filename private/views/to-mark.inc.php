...
<div class="table-responsive container-fluid p-0" >
	<table class="table table-striped table-hover">
		<tr><th></th><th>Nombre prueba</th><th>Estudiante</th><th>Fecha de envio</th>
			<th>Respondido</th>
			<th>Revisado</th>
			<th></th>
		</tr>
			 ...
			 <tr>
			 	<td>
			 		...
			 		<a href="<?=ROOT?>/mark_test/<?=$test_row->test_id?>/<?=$test_row->user->user_id?>">
			 			<button class="btn btn-sm btn-primary">Revisar prueba <i class="fa fa-chevron-right"></i></button>
			 		</a>
			 		<?php endif;?>
			 	</td>
