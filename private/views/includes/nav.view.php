...
<nav class="main-nav navbar navbar-expand-lg navbar-light bg-light p-2">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link <?=($this->controller_name() == 'Home') ? ' active-nav ':''?> " href="<?=ROOT?>">PANEL</a>
      </li>

      <?php if(Auth::access('super_admin')):?>
        <li class="nav-item">
          <a class="nav-link <?=($this->controller_name() == 'Schools') ? ' active-nav ':''?> " href="<?=ROOT?>/schools">ESCUELAS</a>
        </li>
      <?php endif;?>
      ...
      <li class="nav-item">
        <a class="nav-link <?=($this->controller_name() == 'Classes') ? ' active-nav ':''?> " href="<?=ROOT?>/classes">CURSOS</a>
      </li>
      
      <li class="nav-item" style="position: relative;">
        <a class="nav-link <?=($this->controller_name() == 'Tests') ? ' active-nav ':''?> " href="<?=ROOT?>/tests">PRUEBAS
      ...
      <?php if(Auth::access('lecturer')):?>
        <li class="nav-item" style="position: relative;">
          <a class="nav-link <?=($this->controller_name() == 'To_mark') ? ' active-nav ':''?> " href="<?=ROOT?>/to_mark">REVISAR
            <?php  
        ...
        <li class="nav-item">
          <a class="nav-link <?=($this->controller_name() == 'Marked') ? ' active-nav ':''?> " href="<?=ROOT?>/marked">REVISADAS</a>
        </li>
      <?php endif;?>
    ...
    <ul class="navbar-nav ms-auto">
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="<?=ROOT?>">Panel</a>
          <div class="dropdown-divider"></div>
          <a class="dropdown-item" href="<?=ROOT?>/logout">Cerrar sesion</a>
        </div>
      </li>
